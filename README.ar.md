...
**91 tok/s. بدون حاويات. 123GB ذاكرة GPU. مُجمَّع من المصدر. أنا أعرف الكونغ فو.**
...
- **الحاويات تضيف 15-20% حملاً زائداً** على أحمال عمل GPU. عندما تمتلك 123GB من الذاكرة الموحدة على شريحة واحدة، كل واط وكل بايت يجب أن يذهب للاستدلال، لا للتنسيق. *"لا تحاول ثني الملعقة. بدلاً من ذلك، حاول فقط أن تدرك الحقيقة: لا وجود للحاوية."*
- **التجميع من المصدر** يعني تحسينات gfx1151 الأصلية التي تفوتها الحزم المُعدَّة مسبقاً. من هنا تأتي سرعة 91 tok/s.
...
- **توليد الصور** — [ComfyUI](https://github.com/comfyanonymous/ComfyUI) على 123GB GPU، SDXL، Flux
